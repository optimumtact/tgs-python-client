...
class InstanceApi(object):
    ...
    def instance_controller_create(self, api, user_agent, **kwargs):  # noqa: E501
        ...
        :param Instance body: The Tgstation.Server.Api.Models.Instance settings.
        :return: Instance
    ...
    def instance_controller_delete(self, id, api, user_agent, **kwargs):  # noqa: E501
        """Detach an Tgstation.Server.Api.Models.Instance with the given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.instance_controller_delete(id, api, user_agent, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int id: The Tgstation.Server.Api.Models.Instance.Id to detach. (required)
        :param str api: The API version being used in the form \"Tgstation.Server.Api/[API version]\" (required)
        :param str user_agent: The user agent of the calling client. (required)
        :return: None
                 If the method is called asynchronously,
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.instance_controller_delete_with_http_info(id, api, user_agent, **kwargs)  # noqa: E501
        else:
            (data) = self.instance_controller_delete_with_http_info(id, api, user_agent, **kwargs)  # noqa: E501
            return data

    def instance_controller_delete_with_http_info(self, id, api, user_agent, **kwargs):  # noqa: E501
        """Detach an Tgstation.Server.Api.Models.Instance with the given id.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.instance_controller_delete_with_http_info(id, api, user_agent, async_req=True)
        >>> result = thread.get()
    ...
    def instance_controller_get_id(self, id, api, user_agent, **kwargs):  # noqa: E501
        """Get a specific Tgstation.Server.Api.Models.Instance.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.instance_controller_get_id(id, api, user_agent, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int id: The Tgstation.Server.Api.Models.Instance.Id to retrieve. (required)
        :param str api: The API version being used in the form \"Tgstation.Server.Api/[API version]\" (required)
        :param str user_agent: The user agent of the calling client. (required)
        :return: Instance
                 If the method is called asynchronously,
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.instance_controller_get_id_with_http_info(id, api, user_agent, **kwargs)  # noqa: E501
        else:
            (data) = self.instance_controller_get_id_with_http_info(id, api, user_agent, **kwargs)  # noqa: E501
            return data

    def instance_controller_get_id_with_http_info(self, id, api, user_agent, **kwargs):  # noqa: E501
        """Get a specific Tgstation.Server.Api.Models.Instance.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.instance_controller_get_id_with_http_info(id, api, user_agent, async_req=True)
        >>> result = thread.get()
    ...
    def instance_controller_update(self, api, user_agent, **kwargs):  # noqa: E501
        ...
        :param str api: The API version being used in the form \"Tgstation.Server.Api/[API version]\" (required)
        :param str user_agent: The user agent of the calling client. (required)
        :param Instance body: The updated Tgstation.Server.Api.Models.Instance settings.
        :return: Instance
                 If the method is called asynchronously,
                 returns the request thread.
        """
